...
def register_all(registry):
    from . import fs_tools, search_tools, git_tools, tavily_tools, meta_tools, edit_tools, max_tools, tts_tools, additional_tools, rest_api_tool, window_tools, vision_tools
